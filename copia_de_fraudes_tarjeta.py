# -*- coding: utf-8 -*-
"""Copia de FRAUDES_TARJETA.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1alP8xKtewkkd4bBJnCVuYgYaZMVeE-WQ
"""
...
"""SEPARAMOS LOS DATOS POR NIVELES Y CARACTERISTICAS"""

features = data.iloc[:, 1:30]
labels = data.iloc[:, -1]

"""CON LA LIBRERIA DE SCIKIT-LEARN CREAMOS LOS FICHEROS DE TRAINING Y TEST CON LA FUNCION SPLIT"""
...
def recurrent_neural_network_model():
    ...
    lstm_cell = rnn.LSTMCell(n_units)
